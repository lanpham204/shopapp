package com.shopapp.configuration;

import com.shopapp.filter.JwtTokenFilter;
         ...
         http
                ...
                .authorizeHttpRequests((requests -> {
                    requests.requestMatchers(
                            ...
                            .requestMatchers(HttpMethod.POST,String.format("%s/users/details/**",apiPrefix)).hasAnyRole(Role.ADMIN,Role.USER)
                            .requestMatchers(HttpMethod.PUT,String.format("%s/users/**",apiPrefix)).hasAnyRole(Role.ADMIN,Role.USER)
